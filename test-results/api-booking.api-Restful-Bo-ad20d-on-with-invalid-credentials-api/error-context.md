...
- Name: api\booking.api.spec.ts >> Restful Booker API Tests >> should reject auth token creation with invalid credentials
- Location: tests\api\booking.api.spec.ts:114:3
