...
- Name: ui\booking.ui.spec.ts >> Room Booking >> should show error when lastname is missing from booking
- Location: tests\ui\booking.ui.spec.ts:62:3
...
Locator: locator('[data-testid="lastname"], input[name="lastname"], #lastname')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="lastname"], input[name="lastname"], #lastname')
