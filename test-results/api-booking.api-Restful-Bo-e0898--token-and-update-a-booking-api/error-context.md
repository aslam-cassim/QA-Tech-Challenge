...
- Name: api\booking.api.spec.ts >> Restful Booker API Tests >> should create auth token and update a booking
- Location: tests\api\booking.api.spec.ts:50:3
...
```ts
  ...
  2   | import { BookingController, Booking } from '../../src/api/controllers/BookingController.js';
  3   | import { logger } from '../../src/utils/Logger.js';
  4   | 
  5   | test.describe('Restful Booker API Tests', () => {
  6   |   const controller = new BookingController();
  7   |   
