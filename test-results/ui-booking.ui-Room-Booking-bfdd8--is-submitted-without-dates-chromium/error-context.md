...
- Name: ui\booking.ui.spec.ts >> Room Booking >> should show error when booking form is submitted without dates
- Location: tests\ui\booking.ui.spec.ts:46:3
...
Locator: locator('[data-testid="firstname"], input[name="firstname"], #firstname')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="firstname"], input[name="firstname"], #firstname')
